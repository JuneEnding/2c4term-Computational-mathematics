...
namespace GrafObj
{
    public class ControllerEditor
    {
        ...
        public void Paint(Graphics gr)
        {
            ...
            curY1 = curY1 + 20;
            curC = Color.Black;
            gr.DrawString("Интеграл: " + model.Integral, font, new SolidBrush(curC), curX1, curY1 - 10);

            curY1 = curY1 + 20;
            curC = Color.Black;
            gr.DrawString("Погрешность: " + model.Inaccuracy(model.fmatrix, model.Intevalx), font, new SolidBrush(curC), curX1, curY1 - 10);
