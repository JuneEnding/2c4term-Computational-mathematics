...
namespace LabWorkCompMath.Lab1
{
    class Lab1_6 : Lab
    {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        public Lab1_6() : this(null) { }

        public Lab1_6(Button relatedButton) : base(relatedButton)
        {
            labelName = "6.	Найти один из корней полинома методом дихотомии";
