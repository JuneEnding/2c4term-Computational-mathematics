...
namespace LabWorkCompMath.Lab2 {
    class Lab2_6_2 : Lab {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        public Lab2_6_2() : this(null) { }

        public Lab2_6_2(Button relatedButton) : base(relatedButton) {
        ...
        public float[] NewtonI2(List<float[]> a, List<float[]> b, float[] x, float exact = 0.0001f, int maxIter = 10000) {
            error = "";
            iter = 0;
            x0 = x;
